...
#   1. `-x sqlalchemy.url=...` alembic CLI arg (used by pytest fixture)
#   2. `DATABASE_URL` env var (CI, docker, production)
#   3. the [alembic] section in alembic.ini (SQLite default)
