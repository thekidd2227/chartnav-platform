// Phase 79 — Glaucoma summary API client.

import { API_URL } from "../../api";
import type { GlaucomaSummary } from "./glaucomaTypes";
...
export function getGlaucomaSummary(
  patientId: number,
  email?: string | null,
): Promise<GlaucomaSummary> {
  return apiFetch(`/patients/${patientId}/glaucoma-summary`, { email });
}
