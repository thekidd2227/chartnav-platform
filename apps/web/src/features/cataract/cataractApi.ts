// Phase 80 — Cataract workflow API client.

import { API_URL } from "../../api";
import type { CataractWorkflowSummary } from "./cataractTypes";
...
export function getCataractWorkflowSummary(
  patientId: number,
  email?: string | null,
): Promise<CataractWorkflowSummary> {
  return apiFetch(`/patients/${patientId}/cataract-workflow`, { email });
}
