...
ChartNav is provider-reviewed workflow support — partner pitches
do not promise certifications, autonomous diagnosis, or
clinical-action automation we don't ship.

---

## Slide 1 — Cover

- **Title:** ChartNav — partner pitch.
- **Content:**
...
- **Content:**
  - Identify 2–3 ophthalmology practice candidates.
  - Make warm intros.
  - Co-attend the live demo.
  - Co-attend the pilot kick-off.
- **Speaker notes:** Single CTA per partner conversation.
- **Visual:** checklist.
